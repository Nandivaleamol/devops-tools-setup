# Kubernetes 1.30.2 Cluster Setup on Ubuntu 22.04 LTS & 24.04 LTS.
This guide provides step-by-step instructions to set up a Kubernetes 1.30.2 cluster on Ubuntu 22.04 LTS and 24.04 LTS.
...
- **Nodes:** 1 master node(minimum(2 CPU, 4GB RAM)), 2 worker nodes (minimum(1 CPU, 1GB RAM))
    ...
    [plugins."io.containerd.grpc.v1.cri".containerd]
      ...
      [plugins."io.containerd.grpc.v1.cri".containerd.runtimes]
        ...
        [plugins."io.containerd.grpc.v1.cri".containerd.runtimes.runc]
          ...
          container_annotations = []
          pod_annotations = []
          privileged_without_host devices = false
          runtime_engine = ""
          runtime_root = ""
...
### Step 10: Initialize the Cluster and Install CNI (Only Master Nodes)
```
...
kubeadm join 192.168.122.100:6443 --token zcijug.ye3vrct74itrkesp \
        --discovery-token-ca-cert-hash sha256:e9dd1a0638a5a1aa1850c16f4c9eeaa
```